...
async def translate_to_en(callback_query: types.CallbackQuery):
    ...
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'en'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_sp(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'es'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_ch(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'fr'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'de'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'zh'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'ja'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        await bot.send_message(callback_query.from_user.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'ru'))
    except:
        await bot.send_message(callback_query.from_user.id, "Ошибка :c")
