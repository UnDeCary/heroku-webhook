...
async def translate_to_en(callback_query: types.CallbackQuery):
    ...
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'en'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_sp(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'es'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_ch(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'fr'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'de'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'zh'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'ja'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
...
async def translate_to_ger(callback_query: types.CallbackQuery):
    ...
    await bot.answer_callback_query(callback_query.id)
    try:
        return SendMessage(callback_query.chat.id, TextBlob(str(data).replace('(','').replace(')','').replace("'",'').replace(",",'')).translate(to = 'ru'))
    except:
        return SendMessage(callback_query.chat.id, "Ошибка :c")
